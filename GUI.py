...
fileLabel = Label(text="No file selected", fg="grey", font=("Times", 2))
...
uploadButton.grid(row=2, column=0, sticky="nsew", pady=5)
...
compression.grid(row=5, column=0, columnspan=1, pady=5)
...
metadata.grid(row=5, column=0, columnspan=2, pady=5)
...
artifact.grid(row=5, column=0, columnspan=3, pady=5)
...
noise.grid(row=6, column=0, columnspan=2, pady=5)
...
copy_move.grid(row=5, column=2, columnspan=2, pady=5)
...
ela.grid(row=5, column=1, columnspan=3, pady=5)
